...
def main(args):
    ...
    boxes, labels, scores = detect_cracks(image_pil)
    ...
    output_path = os.path.join(os.path.dirname(image_path),"detected_image43.jpg")
    image_pil.save(output_path)
    print("Deteksi retakan selesai. Gambar hasil deteksi disimpan di:", output_path)
